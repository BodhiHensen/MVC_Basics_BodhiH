        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/HorlogeController/update/<?= $data['horloge']->Id; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="merk" type="text" class="form-control" id="merk" value="<?= $_POST['merk'] ?? $data['horloge']->Merk; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" step="0.01" class="form-control" id="prijs" value="<?= $_POST['prijs'] ?? $data['horloge']->Prijs; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" class="form-control" id="gewicht" value="<?= $_POST['gewicht'] ?? $data['horloge']->Gewicht; ?>" required>
                </div>
                <div class="mb-3">
