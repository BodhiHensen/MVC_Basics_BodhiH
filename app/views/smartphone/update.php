        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/update/<?= $data['smartphone']->Id; ?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="merk" type="text" class="form-control" id="merk" value="<?= $_POST['merk'] ?? $data['smartphone']->Merk; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="prijs" type="number" step="0.01" class="form-control" id="prijs" value="<?= $_POST['prijs'] ?? $data['smartphone']->Prijs; ?>" required>
                </div>
                <div class="mb-3">
                    <label for="geheugen" class="form-label">Geheugen (GB)</label>
                    <input name="geheugen" type="number" class="form-control" id="geheugen" value="<?= $_POST['geheugen'] ?? $data['smartphone']->Geheugen; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="schermgrootte" type="number" step="0.01" class="form-control" id="schermgrootte" value="<?= $_POST['schermgrootte'] ?? $data['smartphone']->Schermgrootte; ?>" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input name="megapixels" type="number" class="form-control" id="megapixels" value="<?= $_POST['megapixels'] ?? $data['smartphone']->MegaPixels; ?>" required>
                </div>
